...
def actor_cli(cfg: TrainRLServerPipelineConfig):
    ...
    log_dir = os.path.join(cfg.output_dir, "logsinfer")
    os.makedirs(log_dir, exist_ok=True)
    log_file = os.path.join(log_dir, f"actorinfer_{cfg.job_name}.log")
    ...
    # logging.info("[ACTORinfer] Establishing connection with Learner")
    # if not establish_learner_connection(learner_client, shutdown_event):
    #     logging.error("[ACTORinfer] Failed to establish connection with Learner")
    #     return
